...
def pre_filter_article(title, text):
    ...
    # Relaxed filtering for titles with biology relevance
    non_biology_keywords = [
        'history', 'politics', 'law', 'finance', 'tournament', 'state', 'economics',
        # Consider excluding engineering, medicine, etc., to capture broader science
    ]
    # Remove too generic filters that may exclude scientific terms
...
def is_biology_related(title):
    """
    Check if the article is biology-related based on keywords in the title.
                ...
                with open(wiki_file, 'r', encoding='utf-8') as file:
                    for line in file:
                        ...
                        try:
                            ...
                            # Ensure biology-related articles are captured
...
if __name__ == "__main__":
    ...
    output_file = "../Wikipedia_dumps/training_data_2/biology_training_data_high_quality_2.6.jsonl"
